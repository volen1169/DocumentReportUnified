...
from styles.theme import COLORS, MODERN_THEME, SIDEBAR_V32_THEME
from views.nas_permission_analyzer import render_nas_permission_analyzer
...
from services.excel_storage import (
    ...
    PASSWORD_FILE_NAME,
    SOFTWARE_FILE_MAP,
    parse_password_sheet,
    load_password_excel,
    load_software_excels,
    upload_password_excel,
    _software_workbook_path,
    _get_sharepoint_drive_id,
    load_software_workbook,
    upload_software_workbook,
    _software_sheet_names,
    _software_row_to_sheet_position,
...
from services.ad_directory import (
    ...
    _ad_agent_enabled,
    _default_firewall_policy_rows,
    _escape_ldap_filter_value,
    _extract_cn_from_dn,
    _first_policy_value,
    _ldap_enabled,
    _make_ldap_connection,
    _normalize_ad_identity,
    _secret_bool,
    _source_order,
    format_nas_export_policy_names,
    format_policy_allowed,
    ...
    get_firewall_policy_mapping_dict,
    get_internet_policies_from_groups,
...
from services.nas_service import (
    ...
    synology_login,
    synology_logout,
    synology_get_shares_api,
    load_nas_data_api,
    nas_agent_health,
    nas_agent_get_shares,
    nas_agent_get_acl_payload,
    nas_agent_get_acl_raw,
    _clean_nas_principal,
    parse_nas_agent_permissions_payload,
    parse_synoacl_output,
    fetch_acl_agent,
    load_nas_data_agent,
    create_ssh,
    run_command,
...
# =============================================================================
    ...
    # -------------------------------------------------------
        ...
        if sub == "Computer Asset":
            render_computer_asset(
                ...
                delete_computer_dialog=delete_computer_dialog,
            )
            st.stop()
    ...
    # -------------------------------------------------------
        ...
        render_ad_firewall_policy(
            firewall_policy_mapping_list=FIREWALL_POLICY_MAPPING_LIST,
            fw_policy_map=FW_POLICY_MAP,
            fw_policy_prefixes=FW_POLICY_PREFIXES,
            get_user_internet_policy_summary=get_user_internet_policy_summary,
            get_policy_users_summary=get_policy_users_summary,
            load_firewall_policy_mapping=load_firewall_policy_mapping,
            ldap_find_user=ldap_find_user,
            get_ldap_group_names_for_user=get_ldap_group_names_for_user,
            get_ad_agent_policy_summary=get_ad_agent_policy_summary,
            get_ad_agent_policy_users=get_ad_agent_policy_users,
            graph_find_user=graph_find_user,
            get_ad_group_names_for_user=get_ad_group_names_for_user,
        )
    ...
    # -------------------------------------------------------
        ...
        render_nas_permission_analyzer(
            admin_mode=admin_mode,
            page_header=page_header,
            clean_nas_principal=_clean_nas_principal,
        )
    elif main_menu == "🔑 Password Information":
        render_password_information(
            admin_mode=admin_mode,
            page_header=page_header,
            render_password_card=render_password_card,
            add_password_dialog=add_password_dialog,
            edit_password_dialog=edit_password_dialog,
        )
